...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'dawrynow-theme' ),
            //'description' => __( 'This is a section for the typography', 'dawrynow-theme' ),
            'priority' => 20,
        )
    );
    //Theme Option
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'dawrynow-theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'dawrynow-theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_color_scheme_setting', array(
        'label' => __( 'Color Scheme', 'dawrynow-theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'dawrynow-theme' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'dawrynow-theme' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'dawrynow-theme' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','dawrynow-theme' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'dawrynow-theme' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'dawrynow-theme'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'dawrynow-theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'dawrynow-theme' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'dawrynow-theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'dawrynow-theme' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'dawrynow-theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'dawrynow-theme' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
